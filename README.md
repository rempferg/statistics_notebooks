...
[bernoulli_process/bayesian_pair_credibility_with_slack.ipynb](https://georg-rempfer.github.io/jupyter-lite/lab/index.html?path=bernoulli_process%2Fbayesian_pair_credibility_with_slack.ipynb) *- "I have two different systems, one produced 19 successes and 1 failure in 20 tests, the other produced 18 successes and 2 failures in 20 tests. How confident can I be that both systems perform equally well to within 10% differences in their success rates? I want a best guess and maybe even add in some prior expectation."*
...
You can do so here: https://github.com/rempferg/statistics_notebooks
